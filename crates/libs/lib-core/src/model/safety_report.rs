...
pub struct SenderInformation {
	...
	pub person_title_null_flavor: Option<String>,
	pub person_given_name: Option<String>,
	pub person_given_name_null_flavor: Option<String>,
	pub person_middle_name: Option<String>,
	pub person_middle_name_null_flavor: Option<String>,
	pub person_family_name: Option<String>,
	pub person_family_name_null_flavor: Option<String>,
