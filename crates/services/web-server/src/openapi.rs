...
struct DrugInformationDoc {
	...
	fda_additional_info_coded_null_flavor: Option<String>,
	#[schema(value_type = Object)]
...
struct SenderInformationDoc {
	...
	person_title_null_flavor: Option<String>,
	person_given_name: Option<String>,
	person_given_name_null_flavor: Option<String>,
	person_middle_name: Option<String>,
	person_middle_name_null_flavor: Option<String>,
	person_family_name: Option<String>,
	person_family_name_null_flavor: Option<String>,
