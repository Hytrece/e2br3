...
FRONTEND_TO_BACKEND = {
    ...
    "product": {
        ...
        "activeSubstances[].substanceName": ("ProductPresaveActiveSubstance", "substance_name"),
        "activeSubstances[].substanceTermIdVersion": ("ProductPresaveActiveSubstance", "substance_termid_version"),
        "activeSubstances[].substanceTermId": ("ProductPresaveActiveSubstance", "substance_termid"),
        "activeSubstances[].mfdsVersion": ("ProductPresaveActiveSubstance", "mfds_version"),
        "activeSubstances[].mfdsId": ("ProductPresaveActiveSubstance", "mfds_id"),
        "activeSubstances[].substanceStrengthValue": ("ProductPresaveActiveSubstance", "strength_value"),
        "activeSubstances[].substanceStrengthUnit": ("ProductPresaveActiveSubstance", "strength_unit"),
    },
    "study": {
        ...
        "studyNameNullFlavor": ("StudyPresave", "study_name_null_flavor"),
        ...
        "sponsorStudyNumberNullFlavor": ("StudyPresave", "sponsor_study_number_null_flavor"),
        "studyTypeReaction": ("StudyPresave", "study_type_reaction"),
        "studyTypeReactionKr1": ("StudyPresave", "study_type_reaction_kr1"),
    ...
    "narrative": {
        "templateTitle": ("NarrativePresave", "template_title"),
...
OFFICIAL = {
    ...
    "study": {
        ...
        ("StudyPresave", "study_type_reaction_kr1"): "C.5.4.KR.1",
